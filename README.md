...
```bash
# Backend — 1,170 tests. Needs Postgres running. The sandbox integration tests
...
| Stage | What it does |
|---|---|
| Backend tests | Runs the full pytest suite (1,170 tests) against a real Postgres, plus linting and formatting checks |
